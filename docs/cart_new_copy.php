...
<?php
	...
	if (isset($_POST['checkout']) && !empty($_SESSION['cart'])) {
        ...
        // Create order
			//$dt_order = date('Y-m-d');		
			mysqli_query($conn, "INSERT INTO sales (store_id, staff, customer_id, pay_method, date_paid, grand_total) 
					VALUES ('$store_id', '$sysuser', '$customer_id', '$payMethod', '$grand_total')");
