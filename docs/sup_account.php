...
<?php
 ...
 <table border="1" width='100%' align="center" cellspacing="5" cellpadding="5">
	<tr>
		<td align="center">
		<?php
			$stmt1 = $conn->prepare("SELECT * FROM suppliers WHERE supplier_id = '$pid'");
			$stmt1->execute();		
			...
			while ($c = $result1->fetch_assoc()) {
				...
				print "<span style='font-size:26px; font-weight:bold;'>SUPPLIER ACCOUNT <br>Name: $name; </span>";
			}
		?>
		</td>
	<tr>  
...
<table border="1" width='100%' align="center" cellspacing="5" cellpadding="5">
        ...
        <td align="center">Opennig Balance </td>
...
?>
	...
	<a style="background-color:black; color:white ;padding:6px;" href="view_suppliers.php"><strong>View Suppliers</strong></a>  <button style="float:right" onClick="printContent('t1')">Click to Print</button>
  </div>
