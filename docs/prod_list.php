...
?>
		...
		?>				
				...
				<tr style="font-size:14px;">
					...
					<td class="boo" width="60px" align="center" style="font-size:16px; pading-left:15px"><strong><a title="View detailed info" class="kkk" href='search_material_id.php?prod_id=<?php echo $id; ?>'><?php echo $row['sku'] ?></a></strong></td>	
                    ...
                    <td class="boo" width="" style="font-size:25px; color:red;" align="center"><b><?php echo $row['selling_price'];?></b></td>
					<td class="boo" width="" style="font-size:25px" align="center"><b><?php echo $row['cost_price'];?></b></td>
