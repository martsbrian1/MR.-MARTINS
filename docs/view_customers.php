...
<?php include"../inc/lay_sidebar.php";?>
  ...
  <div class="dew" style = "margin-left: 40px;" > <span style="color:blue; font-size:24px"><a href="#" title="Home"> <?php echo @$title_main;?></a> | <a href ="add_customer.php"> Add Customer</a></span> </div>
...
if($action=='deleted'){
	...
	$stmt = $conn->prepare("SELECT * FROM customers WHERE status = 1 ORDER BY customer_name");	
	$stmt->execute();
    ...
    echo"<table border='1'; width='90%'; style='margin-left: 30px ; align: center'>";//start table
		...
		$result = $stmt->get_result();
            ...
            echo"<tr bgcolor='#FFCC66';>";
				...
				echo "<td width='230px' ; style='padding-left: 15px'><strong>" .$row['customer_name'] . "</strong></td>";
				...
				<?php
				//echo "<td width='100px' ; style='padding-left:15px';>" . "</td>";
