...
<?php include"../inc/lay_sidebar.php";?>
  ...
  <div class="dew" style = "margin-left:-0px"> <span class="tit"><a href="#" title="Home"><?php echo @$title_main;?></a></span><!--<span style="float:right; background-color:yellow; padding:4px; border:solid red"><a href="cart.php">View Cart</a>--></span></div>
